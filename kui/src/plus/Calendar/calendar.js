    ...
    var Calendar = function (params) {
        ...
        var defaults = {
            ...
            monthPickerTemplate:
                ...
                '<a href="#" class="link icon-only picker-calendar-prev-month"><i class="icon-left"></i></a>' +
                '<span class="current-month-value"></span>' +
                '<a href="#" class="link icon-only picker-calendar-next-month"><i class="icon-right"></i></a>' +
                '</div>',
            yearPicker: true,
            yearPickerTemplate:
                '<div class="picker-calendar-year-picker">' +
                '<a href="#" class="link icon-only picker-calendar-prev-year"><i class="icon-left"></i></a>' +
                '<span class="current-year-value"></span>' +
                '<a href="#" class="link icon-only picker-calendar-next-year"><i class="icon-right"></i></a>' +
                '</div>',
            weekHeader: true,
            // Common settings
            scrollToInput: true,
        ...
        p.initCalendarEvents = function () {
            ...
            function handleYearSelector() {
                ...
                yearsPicker.show().animate({translate3d:'0, 0, 0'},300,'easy-out').addClass('picker-calendar-active').siblings().removeClass('picker-calendar-active');
            ...
            function handleMonthSelector() {
                ...
                monthsPicker.show().animate({translate3d:'0, 0, 0'},300,'easy-out').addClass('picker-calendar-active').siblings().removeClass('picker-calendar-active');
                p.updateSelectedInPickers();
        ...
        p.pickYear = function() {
            ...
            if (curYear !== year) {
                ...
                p.container.find('.picker-calendar-years-picker').animate({translate3d:'0, 100%, 0'},300,'easy-out');//.transform('translate3d(0, 100%, 0)');
            }
        };
        ...
        p.pickMonth = function() {
            ...
            if (curMonth !== month) {
                ...
                p.container.find('.picker-calendar-months-picker').animate({translate3d:'0, 100%, 0'},300,'easy-out');//.transform('translate3d(0, 100%, 0)');
            }
        };
        /**
         * End - edit by JSoon
        ...
        p.open = function () {
            ...
            if (!p.opened) {
                ...
                if (p.inline) {
                    ...
                    p.container = $.layer(p.params);//$($.pickerModal(p.pickerHTML));
                    $(p.container)
                        .on('close', function () {
                            onPickerClose();
                        });
